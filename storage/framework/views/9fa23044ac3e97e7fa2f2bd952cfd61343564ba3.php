...
<div class="w3-top ">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large"> 
  ...
  <a  href="<?php echo e(route('admin.reports')); ?>" class="w3-bar-item w3-button w3-padding-large  w3-hover-white <?php if(Request::is('admin/reports/*')||Request::is('admin/reports') ): ?> w3-theme-d4 <?php endif; ?>"><i class="fa fa-folder-open-o w3-margin-right"></i>Reports</a>
...
<?php /**PATH /home/janith/okto zone/PHP developer/student_counsellor /resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>