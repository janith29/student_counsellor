...
<div class="col-sm-3">
  <div class="card bg-primary">
    ...
    <div class="card-body">
      <form action="<?php echo e(route('councillor.reports.offer')); ?>" method="POST"  enctype="multipart/form-data">
...
<div class="col-sm-3">
  <div class="card bg-primary">
    ...
    <div class="card-body">
      <form action="<?php echo e(route('councillor.reports.summary')); ?>" method="POST"  enctype="multipart/form-data">
        <?php echo e(csrf_field()); ?>
...
<div class="col-sm-3">
  <div class="card bg-primary">
    ...
    <div class="card-body">
      ...
      <form action="<?php echo e(route('councillor.reports.apply')); ?>" method="POST"  enctype="multipart/form-data">
        <?php echo e(csrf_field()); ?>
  ...
  <div class="col-sm-3">
    <div class="card bg-primary">
      ...
      <div class="card-body">
        <form action="<?php echo e(route('councillor.reports.university')); ?>" method="POST"  enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>
...
<div class="row margintop">
  ...
  <div class="col-sm-3">
    <div class="card bg-primary">
      ...
      <div class="card-body">
        <form action="<?php echo e(route('councillor.reports.course')); ?>" method="POST"  enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>
  ...
  <div class="col-sm-3">
    <div class="card bg-primary">
      ...
      <div class="card-body">
        ...
        <form action="<?php echo e(route('councillor.reports.age')); ?>" method="POST"  enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>
  ...
  <div class="col-sm-3">
    <div class="card bg-primary">
      ...
      <div class="card-body">
        ...
        <form action="<?php echo e(route('councillor.reports.dates')); ?>" method="POST"  enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('councillor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/janith/okto zone/PHP developer/student_counsellor /resources/views/councillor/reports/welcome.blade.php ENDPATH**/ ?>