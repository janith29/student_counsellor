  ...
  <div class="col-sm-6">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <h3>  <strong> <?php echo e($inquiry->std_name); ?></strong> </h3>
          
        </div>
        <div class="card-body">
        <div class="card "style="margin-top:10px">
            <h5 class="card-title">Student Email:- <strong> <?php echo e(($inquiry->email)); ?></strong></h5>
        </div>
        <div class="card "style="margin-top:10px">
            <h5 class="card-title">Student Age:- <strong> <?php echo e(($inquiry->age)); ?></strong></h5>
        </div>
        <div class="card "style="margin-top:10px">
            <h5 class="card-title">Student Phone Number:- <strong> <?php echo e(($inquiry->phone_num)); ?></strong></h5>
        </div>
        <div class="card "style="margin-top:10px">
            <h5 class="card-title">Student Address:- <strong> <?php echo e(($inquiry->address)); ?></strong></h5>
        </div>
        <div class="card "style="margin-top:10px">
            <h5 class="card-title">University- <strong> <?php echo e(($inquiry->university)); ?></strong></h5>
        </div>
        <div class="card "style="margin-top:10px">
            <h5 class="card-title">Course:- <strong> <?php echo e(($inquiry->course)); ?></strong></h5>
        </div>
        </div>
        <div class="card-footer">
            <a href="/councillor/inquiry" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Go Back</a>
       
            <button class="btn btn-xs btn-warning" data-std_name="<?php echo e($inquiry->std_name); ?>" data-email="<?php echo e($inquiry->email); ?>" data-address="<?php echo e($inquiry->address); ?>" data-phone_num="<?php echo e($inquiry->phone_num); ?>" data-course="<?php echo e($inquiry->course); ?>"  data-start_date="<?php echo e(date("Y-m",strtotime($inquiry->start_date))); ?>" data-university="<?php echo e($inquiry->university); ?>" data-inqid="<?php echo e($inquiry->id); ?>"  data-toggle="modal" data-target="#editinquiry" >
...
<?php echo $__env->make('councillor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/janith/okto zone/PHP developer/student_counsellor /resources/views/councillor/inquiry/show.blade.php ENDPATH**/ ?>