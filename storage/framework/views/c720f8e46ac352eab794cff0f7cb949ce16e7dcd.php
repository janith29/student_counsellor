      ...
      <tbody>
        ...
        ?>
          <tr>
              ...
              <td>
                <a class="btn btn-xs btn-primary" href="<?php echo e(route('councillor.apply.show',$applys->id)); ?>">
                  <i class="fa fa-eye"></i>
                </a>
              </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo e(route('councillor.apply.add')); ?>" method="POST"  enctype="multipart/form-data" autocomplete="off" >
              ...
              <tbody>
                <?php $__currentLoopData = $inquiry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquirys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tr>
                      ...
                      <td>
                        <input type="radio" class="form-control"  id="inquiry-id" name="inquiry-id" value="<?php echo e($inquirys->id); ?>" title="Select inquiry" required>
                      </td>
...
<?php echo $__env->make('councillor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/janith/okto zone/PHP developer/student_counsellor /resources/views/councillor/apply/welcome.blade.php ENDPATH**/ ?>