...
<div class="col-sm-3">
  <div class="card bg-primary">
    ...
    <div class="card-body">
      <form action="{{route('councillor.reports.offer')}}" method="POST"  enctype="multipart/form-data">
        {{ csrf_field() }}
...
<div class="col-sm-3">
  <div class="card bg-primary">
    ...
    <div class="card-body">
      <form action="{{route('councillor.reports.summary')}}" method="POST"  enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="form-group">
          <label for="file-name" class="col-form-label" id="docName">Select One</label>
          <select class="form-control" name="doc" id="doc" required>
...
<div class="col-sm-3">
  <div class="card bg-primary">
    ...
    <div class="card-body">
      ...
      <form action="{{route('councillor.reports.apply')}}" method="POST"  enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="form-group">
          <label for="file-name" class="col-form-label" id="docName">Select One</label>
          <select class="form-control" name="doc" id="doc" required>
  ...
  <div class="col-sm-3">
    <div class="card bg-primary">
      ...
      <div class="card-body">
        <form action="{{route('councillor.reports.university')}}" method="POST"  enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="form-group">
...
<div class="row margintop">
  ...
  <div class="col-sm-3">
    <div class="card bg-primary">
      ...
      <div class="card-body">
        <form action="{{route('councillor.reports.course')}}" method="POST"  enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="form-group">
  ...
  <div class="col-sm-3">
    <div class="card bg-primary">
      ...
      <div class="card-body">
        ...
        <form action="{{route('councillor.reports.age')}}" method="POST"  enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="form-group">
  ...
  <div class="col-sm-3">
    <div class="card bg-primary">
      ...
      <div class="card-body">
        ...
        <form action="{{route('councillor.reports.dates')}}" method="POST"  enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="form-group">
