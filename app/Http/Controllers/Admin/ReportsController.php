...
class ReportsController extends Controller
{
    ...
    public function university(Request $request)
    {
        if($request->university=='all')
        {
         ...
         return view('admin.reports.university',compact('inquiry'));
    ...
    public function course(Request $request)
    {
        if($request->course=='all')
        {
         ...
         return view('admin.reports.course',compact('inquiry'));
    ...
    public function apply(Request $request)
    {
        if($request->doc=='all')
        {
         ...
         return view('admin.reports.apply',compact('inquiry'));
    ...
    public function summary(Request $request)
    {
        if($request->doc=='all')
        {
         ...
         return view('admin.reports.summary',compact('inquiry'));
